...
function getPackages(){
	...
	while ($row=mysqli_fetch_array($run))
				...
				echo "
					...
					<p><b>$service </b></p><br>
				    <a href='delete.php?del_id=$p_id'><button style='float:right; text-decoration:none color: green;'>Add to Cart</a>
				    </div>
					";
									...
									<div class='col-lg-6' data-aos='fade-up'>
										<div class='single_blog'>
											<div class='blog-text wow fadeInLeft'>
												...
												<h5>Price: &#8377; $price </h5>
												<p>$service</p>
												<center><p><a href='cart.php?add_cart=$p_id' class='btn btn-primary btn-lg' style='color:white;'><i class='fa fa-shopping-cart'></i> Remove</a></p></center>
											</div>
											<img class='blog-photo' width='420' height='350'  src='profile/$img'/>
										</div>
									</div>	
...
function getTent(){
	...
	while ($row=mysqli_fetch_array($run))
				...
				echo "
					...
					<p style='float:left; color: red;'>$city</p><br>
					<p><b>$service </b></p><br>
				    <a href='index.php?add_cart=$p_id'><button style='float:right; text-decoration:none color: green;'>Add to Cart</a>
				    </div>
					";		
